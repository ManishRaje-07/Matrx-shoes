...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "We offer a 30-day hassle-free return policy on all unworn shoes in their original packaging. Return shipping labels are fully prepaid and provided on request.",
  },
  {
    question: "Do you ship internationally?",
    answer:
      "Yes, we ship to over 50 countries worldwide. International shipping rates and times are calculated automatically at checkout based on your destination.",
  },
  {
    question: "How do I find my correct size?",
    answer:
      "Our shoes generally run true to size. If you are between sizes, we recommend ordering the half-size larger for running models, or referring to the Size Chart on each product details view.",
  },
  {
    question: "Are MartX running shoes suitable for flat feet?",
    answer:
      "Absolutely! Models such as the Quantum Boost and Infinite Run incorporate dual-density medial posts that provide elite pronation correction and arch support.",
  },
  {
    question: "How long does standard shipping take?",
    answer:
      "Standard shipping takes 3-5 business days. Express shipping (1-2 business days) is also available. Orders over $150 qualify for free standard shipping automatically.",
  },
];
...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "The style and cushioning are out of this world. I've bought three pairs of MartX shoes, and they are easily the best sneakers in my closet. The design turns heads everywhere I go.",
    rating: 5,
    image:
  ...
  },
  {
    ...
    quote:
      "As a professional trainer, I demand both support and durability from my training gear. The Zenith Fit series excels in lateral stabilization and has become my daily go-to at the gym.",
    rating: 5,
    image:
  ...
  },
  {
    ...
    quote:
      "I completed my third full marathon wearing the MartX Aero Glide. Zero blisters, no sore knees. The energy feedback from the carbon plate is incredible and cut my PR by minutes!",
    rating: 5,
    image:
...
export const Home: React.FC = () => {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=1200&auto=format&fit=crop&q=80",
      link: "/product/2",
    },
    {
      id: 3,
      ...
      image:
        "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=1200&auto=format&fit=crop&q=80",
      link: "/product/8",
    },
  ];
        ...
        <div className={styles.featuresContainer}>
          ...
          <div className={styles.featureItem}>
            ...
            <div>
              ...
              <p className={styles.featureText}>
                Prepaid labels, hassle-free returns
              </p>
            </div>
          </div>
          <div className={styles.featureItem}>
      ...
      <section className={styles.newsletterSection}>
        <div className={styles.newsletterCard}>
          ...
          <p className={styles.newsText}>
            Subscribe to get early access to exclusive drops, premium product
            releases, and 10% off your first purchase.
          </p>
